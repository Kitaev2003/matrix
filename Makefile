...
test:
	g++ -g -Wall -Warray-bounds -Wdouble-promotion -Wold-style-cast -Wfloat-equal -Wextra -Wpedantic matrix_functions.cpp matrix_operators.cpp test.cpp -o start -lgtest -lgmock -pthread
valgrind:
